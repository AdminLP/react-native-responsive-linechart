...
var Area = function (props) {
    var _a = React.useContext(ChartContext_1.default), contextData = _a.data, dimensions = _a.dimensions, domain = _a.domain;
    ...
    var points = utils_1.scalePointsToDimensions(__spreadArrays(data), domain, dimensions);
    var pointsWithinDimensions = points.filter(function (p) { return p.x >= 0 && p.x <= dimensions.width; });
