...
var VerticalAxis = function (props) {
    ...
    var finalTickValues = Axis_utils_1.calculateTickValues(tickValues, tickCount, domain.y, includeOriginTick);
    return (React.createElement(React.Fragment, null,
        ...
        finalTickValues.map(function (value) {
            return (React.createElement(React.Fragment, { key: value },
                grid.visible && (React.createElement(react_native_svg_1.Line, { x1: 0, y1: utils_1.scalePointToDimensions({ x: 0, y: value }, domain, dimensions).y, x2: dimensions.width, y2: utils_1.scalePointToDimensions({ x: 0, y: value }, domain, dimensions).y, stroke: grid.stroke.color, strokeWidth: grid.stroke.width, strokeOpacity: grid.stroke.opacity })),
                ticks.visible && (React.createElement(react_native_svg_1.Line, { x1: ticks.dx, y1: utils_1.scalePointToDimensions({ x: 0, y: value }, domain, dimensions).y, x2: ticks.dx + ticks.length, y2: utils_1.scalePointToDimensions({ x: 0, y: value }, domain, dimensions).y, stroke: ticks.stroke.color, strokeWidth: ticks.stroke.width, strokeOpacity: ticks.stroke.opacity })),
                labels.visible && (React.createElement(react_native_svg_1.G, { translateX: labels.label.dx, translateY: labels.label.dy + utils_1.scalePointToDimensions({ x: 0, y: value }, domain, dimensions).y },
